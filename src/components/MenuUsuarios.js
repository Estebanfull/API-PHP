          ...
          <ul className="menu-list">
            <li>
              ...
              <ul className="submenu" style={{ display: submenus.asistencia ? 'block' : 'none' }}>
                <li><Link to="/asistencia/crear">Solicitar </Link></li>
                <li><Link to="/asistencia/modificar">Modificar </Link></li>
                <li><Link to="/asistencia/eliminar">Eliminar</Link></li>
              </ul>
            </li>
            <li>
              <button onClick={() => toggleSubMenu('perfil')}>Perfil</button>
              <ul className="submenu" style={{ display: submenus.perfil ? 'block' : 'none' }}>
                <li><Link to="/perfil/modificar">Modificar </Link></li>
              </ul>
            </li>
          </ul>
        )}
