          ...
          <ul className="menu-list">
            <li>
              ...
              <li><Link to="/Crear-Usuario">Crear</Link></li>
                <li><Link to="/usuarios/modificar">Modificar</Link></li>
                <li><Link to="/usuarios/eliminar">Eliminar</Link></li>
              </ul>
            </li>
            <li>
              ...
              <ul className="submenu" style={{ display: submenus.trabajadores ? 'block' : 'none' }}>
                <li><Link to="/trabajadores/crear">Crear</Link></li>
                <li><Link to="/trabajadores/modificar">Modificar</Link></li>
                <li><Link to="/trabajadores/eliminar">Eliminar</Link></li>
              </ul>
            </li>
            <li>
              ...
              <ul className="submenu" style={{ display: submenus.proveedores ? 'block' : 'none' }}>
                <li><Link to="/proveedores/crear">Crear</Link></li>
                <li><Link to="/proveedores/modificar">Modificar</Link></li>
                <li><Link to="/proveedores/eliminar">Eliminar</Link></li>
              </ul>
            </li>
            <li>
              <button onClick={() => toggleSubMenu('tecnicos')}>Técnicos</button>
              <ul className="submenu" style={{ display: submenus.tecnicos ? 'block' : 'none' }}>
                <li><Link to="/tecnicos/crear">Crear</Link></li>
                <li><Link to="/tecnicos/modificar">Modificar</Link></li>
                <li><Link to="/tecnicos/eliminar">Eliminar</Link></li>
              </ul>
            </li>
          </ul>
        )}
